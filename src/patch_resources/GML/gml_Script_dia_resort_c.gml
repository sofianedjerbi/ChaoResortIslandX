ds_list_add(msg_list, "hey! glad you're here, i've got some news, yeah.")
ds_list_add(msg_list, "i noticed you've been sticking around for a while now.")
ds_list_add(msg_list, "in fact, you're one of the longest visiting tenants i've ever had!")
